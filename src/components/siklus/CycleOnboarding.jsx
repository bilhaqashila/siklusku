    ...
    <fieldset className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <div className="mt-2 flex flex-wrap items-center gap-2 text-xs text-slate-500">
          <span>
            Mulai: {rangeValue.start ? formatDisplayDate(rangeValue.start) : "Belum dipilih"}
          </span>
          <span>{"\u2022"}</span>
          <span>
            Selesai: {rangeValue.end ? formatDisplayDate(rangeValue.end) : "Belum dipilih"}
          </span>
        </div>
      ...
      <div className="space-y-3">
        ...
        <div
          ...
          role="radiogroup"
          aria-label="Skala nyeri haid 1 sampai 10"
        >
          {painScale.map((value) => (
            <button
              key={value}
